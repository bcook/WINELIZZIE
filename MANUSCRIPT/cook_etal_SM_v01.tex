...
\indent Results from the single and multiple variable regressions (climate data from the instrumental CRU climate grids) are shown in Tables 9 (for 1901--1980) and 10 (1981--2007). Temperature is by far the single best predictor of harvest date; precipitation and PDSI are also significant predictors in their own single variable regressions. Adding precipitation and PDSI into the temperature regression model, however, does not substantially improve the explanatory power of the model (R\textsuperscript{2}) and these additional moisture terms are insignificant ($p>0.05$). This suggest that moisture variability does not affect grape phenology directly but, instead, acts through the modulation of temperatures (where drier equals warmer, via the mechanisms discussed previously).
